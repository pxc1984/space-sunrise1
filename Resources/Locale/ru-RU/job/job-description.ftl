...
job-description-cargotech = Оформиляйте заказы, осуществляйте запросы, работайте сообща с другими, чтобы зарабатывать смехотворные суммы денег, тратьте всё на лотерею.
